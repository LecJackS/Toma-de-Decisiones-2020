...
function localUpdateBanditTwoArms(elmtG, elmtGO1, elmtP, elmtC, dist, distd1, ind, sel, outcome, outcomeCum, selection,
	...
	if (ind.length < nTrials){
		...
		if (clickEnabled[clickEnabled.length - 1] === 1){
			//window.alert(nTrials)
			Shiny.onInputChange("ind.length", ind.length);
			//window.alert(ind.length)
			// get reaction Time
